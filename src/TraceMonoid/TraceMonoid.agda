...
instance
  IsSetFreePcm : {A : Type ℓ} {_#_ : A → A → Type ℓ₀} ⦃ _ : IsIndependence _#_ ⦄ → IsSet (FreePcm A _#_)
  IsOfHLevel.iohl IsSetFreePcm = squashFreePcm
...
monFreePcm = makeIsMonoid ^-assoc ^-idR (λ x → refl)
