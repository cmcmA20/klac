...
instance
  IsSetPcm : {A : Type} {_#_ : A → A → Type} ⦃ φ : IsIndependency _#_ ⦄ → IsSet (Pcm A _#_)
  IsOfHLevel.iohl IsSetPcm = squashPcm
...
monPcm = makeIsMonoid (λ x y z → assoc {_} {_} {x} {y} {z}) (λ x → idR)  (λ x → idL )
